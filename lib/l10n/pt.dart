const Map<String, String> pt = {
  ...
  'criar_turma_ok': 'OK',
  "prof_aluno_regular": "Professor / Aluno Regular",
  "importar_instrucao": "Instruções de importação",
  "importar_btn_selecionar": "Selecionar",
  ...
  "dia_sab": "Sab",
  "dia_dom": "Dom",
  "importar_ajuda": "O arquivo CSV deve conter as colunas: Nome e Email.",
  "aluno_detalhes_ver_mapa": "Ver no Mapa",
  "aluno_detalhes_codigo": "Código da Turma",
  "prof_sem_alunos": "Nenhum aluno nesta turma.",
  "inicio_configurar_nfc": "Configure seu acesso por aproximação",
  "adaptacao_sem_turmas_titulo": "Você não está inscrito em nenhuma turma.",
  "adaptacao_sem_turmas_desc": "Para solicitar adaptação, primeiro entre em uma turma usando o código fornecido pelo professor.",
  "aluno_detalhes_sala": "Local da Aula",
  'erro_horario_comercial': 'Horário permitido: 08:00 - 18:00',
  'erro_almoco': 'Horário de almoço (12h-14h) bloqueado.',
  "prof_historico_sem_alunos": "Nenhum aluno inscrito nesta turma.",
  "prof_historico_salvar": "Salvar Alterações",
  "prof_historico_sucesso": "Chamada atualizada com sucesso!",
