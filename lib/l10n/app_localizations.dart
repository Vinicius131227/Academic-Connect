...
class AppLocalizations {
  ...
  // --- LISTAS ESTÁTICAS (Usadas nos Dropdowns) ---
  ...
  static final Map<String, Map<String, String>> _valores = {
    ...
    'es': {
      ...
      'inicio_dashboard': 'Panel General',
      ...
      'aluno_inicio_ver_detalhes': 'Ver Detalles',
      ...
      'adaptacao_formatos': 'Formatos aceptados: PDF, JPG, PNG (max 5MB)',
